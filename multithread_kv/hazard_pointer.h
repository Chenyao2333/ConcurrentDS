...
private:
    ...
    void help_scan_(hprect_t *myhprec) {
        for (hprec_t *hprec = hprec_head; hprec; hprec = hprec->next) {
            if (hprec->active) continue;
